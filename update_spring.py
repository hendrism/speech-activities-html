...
spring_choices = [
    ...
    },
    {
        ...
        "text": "Do you like finding eggs?",
        "image": "images/actions/find-egg.png"
    },
    {
    ...
    },
    {
        ...
        "image": "images/actions/ride-bike.png"
    },
    {
    ...
    },
    {
        ...
        "text": "Do you like catching bugs or flying kites?",
        "choices": [
            {"label": "Catching Bugs", "image": "images/actions/catch-bug.png"},
            {"label": "Flying Kites", "image": "images/objects/kite.png"}
        ]
    },
    {
        "id": "spr_eo_03", "type": "either_or",
        "text": "Do you like bees or butterflies?",
        "choices": [
    ...
    },
    {
        ...
        "text": "Do you like planting seeds or picking flowers?",
        "choices": [
            {"label": "Planting Seeds", "image": "images/actions/plant-seeds.png"},
            {"label": "Picking Flowers", "image": "images/objects/flower.png"}
        ]
    },
    {
        "id": "spr_eo_05", "type": "either_or",
        "text": "Do you like frogs or birds?",
        "choices": [
            {"label": "Frogs", "image": "images/animals/frog.png"},
            {"label": "Birds", "image": "images/animals/bird.png"}
        ]
    },
    {
        "id": "spr_eo_06", "type": "either_or",
        "text": "Do you like picnics or finding eggs?",
        "choices": [
            {"label": "Picnics", "image": "images/actions/picnic.png"},
            {"label": "Finding Eggs", "image": "images/actions/find-egg.png"}
        ]
    },
    {
        "id": "spr_eo_07", "type": "either_or",
        "text": "Do you like umbrellas or raincoats?",
        "choices": [
    ...
    },
    {
        ...
        "text": "Do you like jumping in puddles or riding bikes?",
        "choices": [
            {"label": "Jumping in Puddles", "image": "images/actions/jump-puddle.png"},
            {"label": "Riding Bikes", "image": "images/actions/ride-bike.png"}
        ]
    },
    {
        "id": "spr_eo_10", "type": "either_or",
        "text": "Do you like strawberries or watering flowers?",
        "choices": [
