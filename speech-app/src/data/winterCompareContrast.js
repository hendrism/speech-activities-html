export const winterCompareContrastData = [
    {
        ...
        items: [
            ...
            { id: '1-2', text: 'stands up', zone: 'left' },
            { id: '1-3', text: 'small', zone: 'right' },
            { id: '1-4', text: 'easy to throw', zone: 'right' },
            { id: '1-5', text: 'made of snow', zone: 'middle' },
            { id: '1-6', text: 'cold', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '2-2', text: 'warm', zone: 'left' },
            { id: '2-3', text: 'separate fingers', zone: 'right' },
            { id: '2-4', text: 'good for gripping', zone: 'right' },
            { id: '2-5', text: 'worn on hands', zone: 'middle' },
            { id: '2-6', text: 'used in winter', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '3-2', text: 'used on ice', zone: 'left' },
            { id: '3-3', text: 'have thick soles', zone: 'right' },
            { id: '3-4', text: 'used for walking', zone: 'right' },
            { id: '3-5', text: 'worn on feet', zone: 'middle' },
            { id: '3-6', text: 'protect from cold', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '4-2', text: 'can carry more than one person', zone: 'left' },
            { id: '4-3', text: 'you stand on it', zone: 'right' },
            { id: '4-4', text: 'used for tricks or sliding', zone: 'right' },
            { id: '4-5', text: 'slide on snow', zone: 'middle' },
            { id: '4-6', text: 'used for fun', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '5-2', text: 'made with cocoa', zone: 'left' },
            { id: '5-3', text: 'mild flavor', zone: 'right' },
            { id: '5-4', text: 'made with leaves', zone: 'right' },
            { id: '5-5', text: 'warm drinks', zone: 'middle' },
            { id: '5-6', text: 'good on cold days', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '6-2', text: 'heavy', zone: 'left' },
            { id: '6-3', text: 'sweeps light things', zone: 'right' },
            { id: '6-4', text: 'light to hold', zone: 'right' },
            { id: '6-5', text: 'used for cleaning', zone: 'middle' },
            { id: '6-6', text: 'held with hands', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '7-2', text: 'very warm', zone: 'left' },
            { id: '7-3', text: 'thin', zone: 'right' },
            { id: '7-4', text: 'keeps water out', zone: 'right' },
            { id: '7-5', text: 'worn outdoors', zone: 'middle' },
            { id: '7-6', text: 'protect your body', zone: 'middle' }
        ]
    },
    {
        title: 'Ice vs Snow',
        ...
        items: [
            ...
            { id: '8-2', text: 'smooth', zone: 'left' },
            { id: '8-3', text: 'soft', zone: 'right' },
            { id: '8-4', text: 'fluffy', zone: 'right' },
            { id: '8-5', text: 'cold', zone: 'middle' },
            { id: '8-6', text: 'made of water', zone: 'middle' }
        ]
    },
    {
        ...
        items: [
            ...
            { id: '9-2', text: 'waddles', zone: 'left' },
            { id: '9-3', text: 'has paws', zone: 'right' },
            { id: '9-4', text: 'walks on four legs', zone: 'right' },
            { id: '9-5', text: 'live in cold places', zone: 'middle' },
            { id: '9-6', text: 'thick bodies to stay warm', zone: 'middle' }
        ]
    }
];
